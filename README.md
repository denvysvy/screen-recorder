...
A multi-threaded screen recording application for Windows built with Python.
The project uses a WebView-based UI and supports screen capture, audio recording, and post-processing with FFmpeg.
...
* `recorder.py` → used for building the `.exe` version
...
👉 You must install FFmpeg and add it to your system PATH:
